...
class ResNet_fc(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=100):
        ...
        self.conv5_x = self._make_layer(block, 512, num_block[3], 2)
        self.avg_pool = nn.AdaptiveAvgPool2d((1, 1))
        # self.fc = nn.Linear(512 * block.expansion, num_classes) # TODO: RE-ENABLE?
...
def vgg8(num_classes):
    """ return a VGG 8 object
    """
...
class ensemble_1_resnet18(nn.Module):

    def __init__(self, num_classes, num_models=1, resnet18=resnet18):
        assert num_models == 1
        super(ensemble_1_resnet18, self).__init__()
        self.num_classes = num_classes
        self.num_models = num_models
        self.model_1 = resnet18(self.num_classes)
    ...
    def forward(self, x):
        ...
        probs = torch.cat([prob_1], dim=-1)
        return probs


class ensemble_1_resnet34(nn.Module):

    def __init__(self, num_classes, num_models=1, resnet34=resnet34):
        assert num_models == 1
        super(ensemble_1_resnet34, self).__init__()
        self.num_classes = num_classes
        self.num_models = num_models
...
class cat_1_resnet34(nn.Module):

    def __init__(self, num_classes, num_models=1, resnet34=resnet34):
        assert num_models == 1
        super(cat_1_resnet34, self).__init__()
        self.num_classes = num_classes
        self.num_models = num_models
        self.model_1 = resnet34(self.num_classes)
    ...
    def forward(self, x):
        ...
        prob_1 = nn.Sigmoid()(logit_1)

        probs = torch.cat([prob_1], dim=-1)
        return probs


class ensemble_1_resnet50(nn.Module):

    def __init__(self, num_classes, num_models=1, resnet50=resnet50):
        assert num_models == 1
        super(ensemble_1_resnet50, self).__init__()
        self.num_classes = num_classes
        self.num_models = num_models
...
class ensemble_2_vgg8(nn.Module):

    def __init__(self, num_classes, num_models=2, vgg8=vgg8):
        assert num_models == 2
        super(ensemble_2_vgg8, self).__init__()
        self.num_classes = num_classes
        self.num_models = num_models
        self.model_1 = vgg8(self.num_classes)
        self.model_2 = vgg8(self.num_classes)
    ...
    def forward(self, x):
        ...
        probs = torch.cat([prob_1, prob_2], dim=-1)
        return probs


class avg_ensemble_2_vgg8(nn.Module):

    def __init__(self, num_classes, num_models=2, vgg8=vgg8):
        assert num_models == 2
        super(avg_ensemble_2_vgg8, self).__init__()
        self.num_classes = num_classes
        self.num_models = num_models
        self.model_1 = vgg8(self.num_classes)
        self.model_2 = vgg8(self.num_classes)
    ...
    def forward(self, x):
        ...
        avg_probs = (prob_1+prob_2) / self.num_models
        return avg_probs
...
class ensemble_3_resnet18_fc(nn.Module):
    ...
    def forward(self, x):
        ...
        fcs = functional.dropout_parallel(
            fcs, self.num_models, 10, 0.9, 0.1, training=self.training)
...
class ensemble_5_resnet18_fc(nn.Module):
    ...
    def forward(self, x):
        ...
        fcs = functional.dropout_parallel(
            fcs, self.num_models, 20, 0.9, 0.1, training=self.training)
